...
namespace Spreadsheet20_2
{
    ...
    public partial class MainWindow
    {
        ...
        {
            var richEditControl = new SpreadsheetControl() { CommandBarStyle = CommandBarStyle.Ribbon };
            if (loadDocument)
                richEditControl.DocumentSource =
                    AssemblyHelper.GetResourceStream(Assembly.GetExecutingAssembly(), "Data/Demo.xlsx", true);
